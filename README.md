...
## Updating
This is a single static file. To change anything:
```bash
...
git push
```
Push = auto-redeploys via GitHub Pages in ~1 minute.

## Before adding any new file
Everything in this repo is **public and Google-indexable** — including PDFs. Only commit files you'd hand to a stranger.
